import { TossAuth, File as TossFile } from '@apps-in-toss/web-framework'
import type { TossProfile } from '@/features/card/types'
 ...
 *
 * `File.saveBase64`를 씁니다. 예전 `saveBase64Data`는 SDK가 deprecated 로 표시해
 * `File.saveBase64` 사용을 안내하고 있어요. 시그니처는 같습니다.
 */
